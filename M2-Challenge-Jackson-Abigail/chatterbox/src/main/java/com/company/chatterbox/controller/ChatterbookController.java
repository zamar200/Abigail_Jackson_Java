package com.company.chatterbox.controller;

import com.company.chatterbox.models.ChatterPost;
import com.company.chatterbox.models.User;
...
public class ChatterbookController {
    ...
    //returns the list of user objects on ChatterBox
    ...
    //returns a list of ChatterPosts based on the given username
    @RequestMapping(value = "/chatterPosts/{name}", method = RequestMethod.GET)
    public List<ChatterPost> returnChatterPosts(@PathVariable String name) {
        for (User user: userList) {
            if (name.equals(user.getName())) {
